      ...
      <q-tab-panels v-model="startTab" animated infinite>
        <q-tab-panel name="general">
          ...
          <q-btn
            ...
            :label="$t('button.deleteCSP')"
            @click="deleteCloudStorageProvider"
          />
          <q-btn
            no-caps
            outline
            ...
            :label="$t('button.deleteAllSettings')"
        ...
        <q-tab-panel name="import">
          ...
          <q-input
            ...
            :type="isPasswordImport ? 'password' : 'text'"
            :label="$t('input.importPassphrase')"
            class="q-my-sm"
          >
          ...
          <q-field outlined :label="$t('input.selectSourceFile')" stack-label>
            <template v-slot:control>
              <div class="self-center full-width no-outline" tabindex="0">
                <label for="fileImport" class="btn">{{
                  $t('input.chooseSourceFile')
                }}</label>
                <input
                  id="fileImport"
                  style="visibility: hidden; display: none"
                  type="file"
                  @change="onImportNotesClick"
                />
                <label class="q-ml-md">{{
                  filePath != null ? filePath : $t('placeholder.noFileChosen')
                }}</label>
              </div>
            </template>
          </q-field>
        ...
        <q-tab-panel name="export">
          ...
          <q-input
            ...
            :type="isPasswordExport ? 'password' : 'text'"
            :label="$t('input.exportPassphrase')"
            class="q-my-sm"
          >
            <template v-slot:append>
              <q-icon
          ...
          <q-btn
            ...
            @click="onExportNotesClick"
          />
        </q-tab-panel>

        <q-tab-panel name="cloud">
          <div class="text-h6">
            {{ $t('setting.title.cloudStorageIntegration') }}
          </div>
          <div class="q-pa-md">
            <q-stepper
  ...
  methods: {
    ...
    onExportNotesClick() {
      ...
      let encodedUri = encodeURI(
        'data:application/json;charset=utf-8,' + encrypted
      );
